...
RUN yum -y install fontconfig libxcb-devel libxkbcommon-x11-devel mesa-libGL-devel xcb-util-image xcb-util-keysyms xcb-util-renderutil xcb-util-wm zlib-devel \
 && yum clean all
